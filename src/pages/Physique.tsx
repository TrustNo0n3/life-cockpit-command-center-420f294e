  ...
  const handleAddWorkout = () => {
    if (newWorkout.trim()) {
      toast({
        ...
        description: `"${newWorkout}" has been added to your workout log.`,
      });
      setNewWorkout("");
    }
  };
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <Label htmlFor="new-workout">Log Workout</Label>
                  <div className="flex gap-2 mt-1">
                    ...
                    />
                    <Button onClick={handleAddWorkout} style={{ backgroundColor: "#d84315" }}>
                      Add
                    </Button>
                  </div>
                </div>
