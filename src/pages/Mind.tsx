            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center text-muted-foreground">
                  ...
                  <p>Enhanced reading tracker coming soon</p>
                  <p className="text-sm mt-1">Track books, set reading goals, and take notes</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center text-muted-foreground">
                  ...
                  <p>Enhanced journaling experience coming soon</p>
                  <p className="text-sm mt-1">Prompts, search, and reflection analytics</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
